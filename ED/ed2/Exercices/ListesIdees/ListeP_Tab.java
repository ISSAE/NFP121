...
//    private int nbreElements;  // nombre d'éléments de la tabImplantation :  toujours nbreElements<=tabImplantation.length
 ...
 */
    ...
    {
        if(listeVide()) throw new ListeVideException();
        return tabImplantation[nbreElements-1];
    }
/**
 * destruction du premier élément de la tabImplantation
 * ATTENTION au redimensionnement du tableau quand c'est nécessaire
 */
      public void cdr()  throws  ListeVideException 
      {
        ...
        * ATTENTION le tableau tabImplantation peut être plein cf java.lang.System pour 
    ...
    public void conc(ListePointInterface lst ){
        if(listeVide()){
         ...
         // ATTENTION exception levée si une des 2 tabImplantations est nulle
      ...
      /** 
       * procédure : retouner une tabImplantation sur elle même
       */ 
    ...
    /**
     * prédicat : objet est -il membre de la tabImplantation ?
     * ATTENTION à ne pas comparer n'importe quoi et obtenir "un false silecieux"
     */
...
/*            if(tabImplantation[i].getClass()==objet.getClass()) {
                ...
                //la formule ci dessus est issue d'une étude de la classe Class.
...
// //         // l'iterator est la seule manière d'énumérer les éléments d'une tabImplantation
...
// //            }
// //           return true;
//         // solution violente avant la vraie : deux tabImplantations sont égales si leurs "toString" sont egales
//         return lst.toString().equals(((ListePointInterface)lst).toString());
//        }
       /*
        * un iterator implanté avec une classe anonyme
        * montrer avec une classe interne (et une classe externe ???)
        * constater les fichiers générés.
        */
